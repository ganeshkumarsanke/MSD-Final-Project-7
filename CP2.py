...
with open(file_name, 'r') as file:
    for line in file:
        ...
        address = bin(address)[2:].zfill(33)  # converting it to binary and making sure it's 34 bits
...
def pop_add_retire_list(add_retire_list):
    if(len(add_retire_list)>0):
            ...
            if(retire_object[2]=='0'):
                write_file.writelines(str(retire_object[0])+" 0 "+"ACT0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"ACT1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"RD0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"RD1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"PRE "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n\n")
                ...
                print(str(retire_object[0])+" 0 "+"RD0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                print(str(retire_object[0])+" 0 "+"RD1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                print(str(retire_object[0])+" 0 "+"PRE "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
            elif(retire_object[2]=='1'):
                write_file.writelines(str(retire_object[0])+" 0 "+"ACT0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"ACT1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"WRite0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"WRite1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"PRE "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n\n")
                print(str(retire_object[0])+" 0 "+"ACT0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                print(str(retire_object[0])+" 0 "+"ACT1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                ...
                write_file.writelines(str(retire_object[0])+" 0 "+"ACT0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"ACT1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"IF0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"IF1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[4][2:]+"\n")
                write_file.writelines(str(retire_object[0])+" 0 "+"PRE "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n\n")
                print(str(retire_object[0])+" 0 "+"ACT0 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
                print(str(retire_object[0])+" 0 "+"ACT1 "+retire_object[6]+" "+retire_object[5]+" "+retire_object[3][2:]+"\n")
...
while(len(sorted_list)!=0):
    ...
    for i in add_retire_list:
        print(i)
    print("\nCPU cycles are "+str(cpu_cycles)+" Dimm cycles "+str(dimm_cycles))
