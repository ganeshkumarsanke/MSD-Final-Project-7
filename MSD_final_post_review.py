    ...
    for line in file:
        ...
        if line.strip():
            ...
            if Time in trace_file_dictionary.keys():
                trace_file_dictionary[Time].append(
                    [int(core), operation, str(row), str(high_column_bits), str(bank), str(bank_group)])
            else:
                trace_file_dictionary[Time] = [
                    [int(core), operation, str(row), str(high_column_bits), str(bank), str(bank_group)]]
    ...
    if len(add_retire_list) > 0:
        ...
        if retire_object[2] == '0':
            ...
            if int(p_bg) == int(retire_object[6]) and int(p_b) == int(retire_object[5]):
                ...
                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "ACT0 ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + retire_object[3][2:].ljust(10) + "\n")
                CurrentTime = CurrentTime + 2

                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "ACT1 ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + retire_object[3][2:].ljust(10) + "\n")
                ...
                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "RD0 ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + retire_object[4][2:].ljust(10) + "\n")
                CurrentTime = CurrentTime + 2

                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "RD1 ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + retire_object[4][2:].ljust(10) + "\n")
                CurrentTime = int(same_row_active) + tRAS * 2

                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "PRE ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + "\n\n")
                ...
                p_b = retire_object[5]
                prev_instruction = retire_object[0]
        ...
        # ------------------------------- If Operation is Write ----------------------------------
            ...
            if int(p_bg) == int(retire_object[6]) and int(p_b) == int(retire_object[5]):
                ...
                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "WR0 ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + retire_object[4][2:].ljust(10) + "\n")
                CurrentTime = CurrentTime + 2

                write_file.writelines(
                    (str(CurrentTime).zfill(16)).ljust(20) + " 0 ".ljust(10) + "WR1 ".ljust(10) + retire_object[
                        6].ljust(10) + retire_object[5].ljust(10) + retire_object[4][2:].ljust(10) + "\n")

                CurrentTime = CurrentTime + (tCWD + tBURST + tWR) * 2
