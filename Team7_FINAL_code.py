    ...
    if len(add_retire_list) > 0:
            ...
            # -------------------------------- If same bank and bank group --------------------------
                if int(p_bg) == int(retire_object[6]) and int(p_b) == int(retire_object[5]):
                    ...
                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20) +" 0 ".ljust(10) +"ACT0 ".ljust(10) +retire_object[6].ljust(10)+retire_object[5].ljust(10)+retire_object[3][2:].ljust(10) +"\n")
                    CurrentTime = CurrentTime + 2

                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20)+" 0 ".ljust(10)+"ACT1 ".ljust(10)+retire_object[6].ljust(10)+retire_object[5].ljust(10)+retire_object[3][2:].ljust(10)+"\n")
                    same_row_active = int(CurrentTime)

                    CurrentTime = CurrentTime + tRCD * 2

                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20)+" 0 ".ljust(10)+"RD0 ".ljust(10)+retire_object[6].ljust(10)+retire_object[5].ljust(10)+retire_object[4][2:].ljust(10)+"\n")
                    CurrentTime = CurrentTime + 2

                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20)+" 0 ".ljust(10)+"RD1 ".ljust(10)+retire_object[6].ljust(10)+retire_object[5].ljust(10)+retire_object[4][2:].ljust(10)+"\n")
                    CurrentTime = int(same_row_active) + tRAS * 2

                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20)+" 0 ".ljust(10)+"PRE ".ljust(10)+retire_object[6].ljust(10)+retire_object[5].ljust(10)+"\n\n")
            ...
            # ------------------------------- If Operation is Write ----------------------------------
                ...
                if int(p_bg) == int(retire_object[6]) and int(p_b) == int(retire_object[5]):
                    ...
                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20)+" 0 ".ljust(10)+ "WR0 ".ljust(10)+retire_object[6].ljust(10) + retire_object[5].ljust(10)+retire_object[4][2:].ljust(10)+"\n")
                    CurrentTime = CurrentTime + 2

                    write_file.writelines((str(CurrentTime).zfill(16)).ljust(20)+" 0 ".ljust(10)+ "WR1 ".ljust(10)+retire_object[6].ljust(10)+retire_object[5].ljust(10)+retire_object[4][2:].ljust(10)+"\n")
            ...
            print("Instruction removed from the queue after processing. ")
